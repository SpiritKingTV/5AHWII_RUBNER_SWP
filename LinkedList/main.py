...
if __name__ == "__main__":
    ...
    #print("sorted:")
    #print(ar.returnAll())
    print("Results InsertionSort:")
    print("----------------------------------------")
    print("Linked List: ", timell,"Sekunden")
    print("Array-List: ", timear,"Sekunden")
    print("----------------------------------------")
    print("Linked List: ", timell*1000, "Millisekunden")
    print("Array-List: ", timear*1000, "Millisekunden")
    print("----------------------------------------")
    if(timell> timear):
        print("Linked List brauch Länger (", (timell - timear), "Sekunden )")
        print("Linked List brauch Länger (", (timell - timear)*1000, "Millisekunden )")
        print("----------------------------------------")
    else:
        print("Array-List brauch Länger (", (timear - timell), "Sekunden )")
        print("Array-List brauch Länger (", (timear - timell)*1000, "Millisekunden )")
        print("----------------------------------------")
    print("Aufwandsklasse: n^2")
    print("----------------------------------------")
    # print(ll.find(6))
    # print(ll.find(1))
